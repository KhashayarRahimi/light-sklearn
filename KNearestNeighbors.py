...
print(KNN.accuracy(y_test,y_pred)) ----> 0.95
...
KNN = KNearestNeighbors.KNN(task = 'regression',n_neighbors=30,r=3)

#KNN.fit(X_train,y_train)

y_pred = KNN.predict(X_train,y_train,X_test)

print(KNN.accuracy(y_test,y_pred)) ------> 0.091
